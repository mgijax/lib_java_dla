...
public class DerivationLookupByName extends FullCachedLookup {
 ...
 /**
    ...
    */
	...
	//System.out.println("DerivationLookupByName name: '" + name);
	//System.out.println( "cache: " + this.cache.keySet().toString());
	if (translator == null){
    ...
    public RowDataInterpreter getRowDataInterpreter()  {
		...
		try {
		    ...
		    throw new InterpretException ("DerivationLookupByName " + e.getMessage());
		}
